package smirnov.bn.service_3.configuration;
...
import smirnov.bn.service_3.interceptor.TokenCheckInterceptor;
...
//    }
    ...
    @Override
    public void addInterceptors(final InterceptorRegistry registry) {
        logger.info("CustomConfigForInterceptors service_3 addInterceptors() - START");
