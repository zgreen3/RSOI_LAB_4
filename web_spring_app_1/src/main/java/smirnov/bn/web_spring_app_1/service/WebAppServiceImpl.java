...
public class WebAppServiceImpl implements WebAppService {
    ...
    public UUID createEmployee(EmployeeInfo employeeInfo) {
        ...
        ResponseEntity<EmployeeInfo> employeesResponse =
        ...
        return ((EmployeeInfo) employeesResponse.getBody()).getEmployeeUuid();
    }
    ...
    public List<EmployeeInfo> findAllEmployees() {
        ...
        return restTemplate.exchange(READ_ALL_EMP_GET_URI_TMPLT, //"http://localhost:8193/employees/read-all",
