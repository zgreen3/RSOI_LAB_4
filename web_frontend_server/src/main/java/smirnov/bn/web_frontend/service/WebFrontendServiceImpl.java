...
import smirnov.bn.web_frontend.model.AuthorizationCodeInfo;
import smirnov.bn.web_frontend.model.UserInfo;


public class WebFrontendServiceImpl implements WebFrontendService {

    private static final Logger logger = LoggerFactory.getLogger(WebFrontendServiceImpl.class);
    ...
    public UUID createUser(UserInfo userInfo) {
        logger.info("createUser() in WebFrontendServiceImpl class in rest_api_frontend module - START");
    ...
    public String hashPassword(String password) {
        logger.info("hashPassword() in WebFrontendServiceImpl class in rest_api_frontend module - START");
    ...
    public UserInfo findUserByLoginEmail(String userLogin, String userEmail) {
        logger.info("findUserByLoginEmail() in WebFrontendServiceImpl class in rest_api_frontend module - START");
        // https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/http/HttpEntity.html (:)
    ...
    public UUID createAuthenticationCode(String clientId, String redirectionUri) {
        logger.info("createAuthenticationCode() in WebFrontendServiceImpl class in rest_api_frontend module - START");
