...
public interface TokenRepository
        ...
        @Transactional
        @Modifying
        @Query(value = "UPDATE tokens SET is_invalidated = true, is_expired = true WHERE access_token_uuid = :accessTokenUuid AND ((current_timestamp > last_used_date_time + interval '1' HOUR * 0.5) OR (current_timestamp > created_date_time + interval '1' HOUR * (2)))",
                nativeQuery = true)
